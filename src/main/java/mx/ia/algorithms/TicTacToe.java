...
public class TicTacToe {
	...
	public static void main(String[] args) {
		...
		if (play) {
			...
			String[][] testBoard = { { "o", "e", "e" }, { "e", "m", "e" }, { "e", "e", "o" } };
...
class TicTacToeElement {
	private int[][] priorities = { { 0, -10, -100, -1000 }, { 11, 0, 10, 0 }, { 101, 10, 0, 0 }, { 1001, 0, 0, 0 } };
	private int[][] heuristicStrategy = { { 2, 1, 2 }, { 1, 0, 1 }, { 2, 1, 2 } };
